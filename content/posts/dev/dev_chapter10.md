...
#### 2.3.2 SCrudService 类和 SCrudServiceImpl 类  
SCrudService.java
```
public interface SCrudService<T, ID extends Serializable> {
    int save(T entity);
    int update(T entity);
    int remove(ID id);
    T get(ID id);
