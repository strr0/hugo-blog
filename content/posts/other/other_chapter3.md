...
![](/images/other_chapter3/DiskManagement.jpg)  
在 U 盘根目录创建 com.apple.recovery.boot 目录，并将下载的镜像文件 BaseSystem 放到该目录下。  
![](/images/other_chapter3/com-recovery.png)  
打开下载的 OpenCorePkg 目录  
![](/images/other_chapter3/base-oc-folder.png)  
从 IA32 （32位）或 X64 （64位）目录选择合适的 EFI 放入 U 盘根目录，最终如下：  
![](/images/other_chapter3/com-efi-done.png)  

### 1.2 基本配置文件
保留基本配置文件，删除多余配置文件，最终如下：  
![Clean EFI](/images/other_chapter3/clean-efi.png)  

### 1.3 收集文件
#### 通用驱动
- [HfsPlus.efi]（必要）(https://github.com/acidanthera/OcBinaryData/blob/master/Drivers/HfsPlus.efi)
